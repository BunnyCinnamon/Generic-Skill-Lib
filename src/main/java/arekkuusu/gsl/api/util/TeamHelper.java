...
public final class TeamHelper {
    ...
    public static final Predicate<Entity> NOT_SPECTATING = e -> !e.isSpectator() && !e.noClip && e.canBeCollidedWith();
    public static final Predicate<Entity> NOT_CREATIVE = entity -> !(entity instanceof PlayerEntity) || !((PlayerEntity) entity).isCreative() || !((PlayerEntity) entity).abilities.disableDamage;
    public static final Predicate<Entity> HUMAN_TEAM = entity -> (GSLAPI.defaultHumanTeam && entity instanceof PlayerEntity) || (GSLAPI.defaultAnimalTeam && entity.getType().getClassification() != EntityClassification.MONSTER);
    public static final Predicate<Entity> NOT_HUMAN_TEAM = entity -> (!GSLAPI.defaultHumanTeam && entity instanceof PlayerEntity) || (!GSLAPI.defaultAnimalTeam || entity.getType().getClassification() == EntityClassification.MONSTER);
