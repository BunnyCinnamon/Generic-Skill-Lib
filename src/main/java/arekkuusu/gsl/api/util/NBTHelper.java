...
public final class NBTHelper {
    ...
    public static int getInt(CompoundNBT compound, String tag) {
    ...
    public static <T extends Enum<T> & IStringSerializable> void setEnum(CompoundNBT compound, T t, String tag) {
        compound.putString(tag, t.func_176610_l());
    }

    public static <T extends Enum<T> & IStringSerializable> T getEnum(Class<T> clazz, CompoundNBT compound, String tag) {
        String value = compound.getString(tag);
        return Stream.of(clazz.getEnumConstants()).filter(e -> e.func_176610_l().equals(value)).findAny().orElseGet(() -> clazz.getEnumConstants()[0]);
    }
    ...
    public static ListNBT getNBTList(CompoundNBT compound, String tag) {
