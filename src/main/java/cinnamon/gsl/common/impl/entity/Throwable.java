...
public class Throwable extends AbstractHurtingProjectile {
    ...
    protected void onHit(HitResult pResult) {
        ...
        if (!this.level.isClientSide() && this.isAlive()) {
            ...
            if(Objects.nonNull(instance)) {
                ...
                instance.setPos(pResult.getLocation().x, pResult.getLocation().y, pResult.getLocation().z);
                instance.xRot = (Mth.wrapDegrees(getXRot()));
                instance.yRot = (Mth.wrapDegrees(getYRot() + 180F));
                ...
                if(instance.getDimensionsType() == StrategicDimensions.Type.ON_HIT) {
                    if(instance.getDirection() != null) {
                        ...
                        instance.lookAt(EntityAnchorArgument.Anchor.FEET, instance.getEyePosition(0F).add(normal.getX(), normal.getY(), normal.getZ()));
                    } else {
    ...
    public void setYRot(float p_146923_) {
        if (!Float.isFinite(p_146923_)) {
            Util.pauseInIde(new java.lang.Throwable("Invalid entity rotation: " + p_146923_ + ", discarding."));
        } else {
    ...
    public void setXRot(float p_146927_) {
        if (!Float.isFinite(p_146927_)) {
            Util.pauseInIde(new java.lang.Throwable("Invalid entity rotation: " + p_146927_ + ", discarding."));
        } else {
